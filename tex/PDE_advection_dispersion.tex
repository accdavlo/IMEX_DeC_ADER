...
\begin{figure}
	...
	%	\begin{minipage}[t]{0.45\textwidth}
		%		\centering
		%		\includegraphics[width=\textwidth]{pdf/pdepics/disp/IMEXDeC_gaussLobatto_disp_advTMM_2-6_small.pdf}
		%		\small$[\DeC, \GLB,k,A_k,P_u]$(zoomed)\par
		%	\end{minipage}\hfill
	%	\begin{minipage}[t]{0.45\textwidth}
		%		\centering
		%		\includegraphics[width=\textwidth]{pdf/pdepics/disp/IMEXADER_gaussLobatto_disp_advTMM_2-6_small.pdf}
		%		\small$[\ADER, \GLB,k,A_k,P_u]$(zoomed)\par
		%	\end{minipage}
